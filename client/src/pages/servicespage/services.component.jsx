...
const ServicesPage = ({history}) => (
   <PageContainer>
    ...
    <PageText style={{marginBottom: '45px'}}>Offering freshly curated beats on a weekly basis for non-exclusive and exclusive licensing. Also, look for Dale Street Studio NFTs coming soon on OpenSea.io. Custom Production services also available by booking services.
    </PageText>
    ...
    <PageText style={{marginBottom: '45px'}}>A fan of beat culture and want to show it in style? Then head over to Merch to get in gear at BeatStyle.com. (coming soon!)
    </PageText>
    <center><a href={'https://beatstyle.launchcart.store/shop'}><CustomButton style={{textAlign: 'center'}}>See more</CustomButton></a></center>
    <br/>
